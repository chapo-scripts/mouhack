...
������ ������:
	��� ������� �������� ������� init() �� ������ Hotkey � �������� � ���������:
		[1] vkeys:
			��� ������ � ������ ������ ��� ������ ����.
			����� ��������� �������������� ���� vkeys.VK_WHEELDOWN � vkeys.VK_WHEELUP.
		[2] imgui:
			��� ������ � mimgui � ��� ��������� ������ ������
...
������� ���������� ��� �������������� ������:
	VK_BACK (Backspace):
		������ ���������� ������ ������ (�������� ������ �������)
	{VK_RETURN (Enter), VK_TAB, VK_F6, VK_F7, VK_F8, VK_T, VK_OEM_3 (���� ~)} � VK_ESCAPE:
		������� ��� ������ �������������� (� �������� ��� ��� ����)
...
�������� ������ � �� ����������� ��������:
	...
	consume_last_key: integer = Hotkey.CONSUME_KEY_FLAG.NONE
		���� ����� �� ���������� ��������� ������� �������/������ ����� ����.
		����� ����� ��������� �������, ���������� � ������� Hotkey.CONSUME_KEY_FLAG:
			CONSUME_KEY_FLAG.NONE 									- ���������� ������;
			CONSUME_KEY_FLAG.FOR_GAME								- �� ���������� ������ ��� ����;
			CONSUME_KEY_FLAG.FOR_SCRIPT								- �� ���������� ������ ��� ��������;
			CONSUME_KEY_FLAG.FOR_GAME + CONSUME_KEY_FLAG.FOR_SCRIPT	- �� ���������� � ��� ���� � ��� ��������.
	
	consume_all_keys: boolean = false
		���� not nil and not false, ��������� ��� ������� �������/������ � ����. ������ `keys` � �� ���������� ��������� ������� �������/������ ������ ��� ����, ���� �� ����� `consume_last_key`
...
�������� ������� ������:
	Hotkey.register(keys, action [, consume_last_key] [, consume_all_keys]) -> id: integer
		��������� ����� ���������� ������.
		���� ���������� `action` �������� ������� `Hotkey.OnSetStatus`,
		�� ���� ����� ������ ���� ������������� ��������� ������ (Hotkey._status),
		� ����� ����������� ���������� �� `Hotkey._status`.
		`consume_last_key` � `consume_all_keys` ������� � ��������� ����� �������.
		���������� ID ������ �����
...
function M.BeginConflictPopup(strId)
	...
	if imgui.BeginPopupModal(strId or 'hotkey-warning', nil, imgui.WindowFlags.AlwaysAutoResize + imgui.WindowFlags.NoDecoration) then
        ...
        if (UI.Components.button(u8'��������##hotkey-confirm', imgui.ImVec2(150, 26), false)) then
        ...
        imgui.SameLine()
        if (UI.Components.button(u8'�������� �����##hotkey-all-allow', imgui.ImVec2(150, 26), false)) then
            Hotkey.copy(Hotkey[lastEditedParam.hotkeyId].keys, Hotkey[lastEditedParam.hotkeyId].newKeys)
            SaveConfig()
            imgui.CloseCurrentPopup();
        end
        imgui.SameLine()
        if (UI.Components.button(u8'������##hotkey-cancel', imgui.ImVec2(150, 26), false)) then
            imgui.CloseCurrentPopup();
        end
        imgui.EndPopup()
    end
...
-- ��������� ����� ���������� ������. ���� ���������� `action` �������� ������� `Hotkey`, �� ���� ����� ������ ���� ������������� ��������� ������ (`Hotkey._status`)
---@param keys table							���������� ������
---@param action function					�������-��������
---@param consume_last_key? CONSUME_KEY_FLAG	���� ����� �� ���������� ��������� ������� �������/������ ����� ����. ����� ���� ����� ��� ������������ �� `Hotkey.CONSUME_KEY_FLAG`
---@param consume_all_keys? boolean 			���� not nil and not false, ��������� ��� ������� ������� ����. ������ `keys` � �� ���������� ��������� ������� �������/������ ������ ��� ����, ���� �� ����� `consume_last_key`
---@return integer|nil id						���������� ID ������ �����
...
-- ���������� ������ � ���� ������ `imgui.Button`. ������������ ������ ������ `imgui.OnDrawFrame`!
---@param id integer
---@param name? string			���� �� nil, ���������� ������ � ��������� `name`
---@param size? ImVec2			������ ������ ������
---@return boolean|nil edited	���������� true, ���� ������ ������ ��� ��� ��������������
function M.Draw(id, name, size)
	if type(id) == "number" and M[id] then
		...
		UI.Components.Hint('hint-hotkey-' .. id, u8'����� ������ �������, ����������� Backspace')
...
---���������� ��������������� �������-������, ���������� ID ���� ������������������ ������ �� ������ ������
---@generic T
---@param comp? fun(a: T, b: T):boolean ������� ����������. ��-��������� ������ `a < b`
---@return T[] id_list
...
-- �������� ������� ������� ������/������. ��������� ������ �� �������/������ ����� �����: Hotkey.getDownKeys[*key_code*] == true|nil
---@param asList? boolean	���� true, �� ������ �������� � ���� ������: {..., *key_code*, ...}
